...
class TweetsGraphCreator:
    ...
    def create_graph(self, users , tweets , user_tweet_relations, tweet_tweet_relations, tweet_tag_relations):
        with self.driver.session(database=self.db_name) as session:
            ...
            for t_t_relation in tweet_tag_relations:
                session.write_transaction(self.graph_operations.create_tweet_tag_relation, t_t_relation  )
